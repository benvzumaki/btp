...
const Footer = () => {
    ...
    return (
        <footer className="overflow-hidden fixed flex items-center gap-2 font-my-font text-xs left-[-180px] sm:left-[-160px] md:left-[-120px] lg:left-[-85px] bottom-40 text-my-white-dark dark:text-my-black-light -rotate-90">
